...
// found in the flutter_license.txt file.

// The exDock project has edited these contents to include hover functionality.
...
///
/// The appearance of all of the [HoverableNavigationRail]s within an app can be
...
///
/// {@tool dartpad}
/// This example shows a [HoverableNavigationRail] used within a Scaffold with 3
...
///
/// {@tool dartpad}
/// This sample shows the creation of [HoverableNavigationRail] widget used within a Scaffold with 3
...
class HoverableNavigationRail extends StatefulWidget {
  ...
  ///
  /// If [minWidth] is specified, it must be non-negawidget.labelType ??tive, and if
  ...
  /// Sets the color of the Container that holds all of the [HoverableNavigationRail]'s
  /// contents.
  ///
  ...
  /// Indicates that the [HoverableNavigationRail] should be in the extended state.
  ///
  ...
  /// values.
  final List<HoverableNavigationRailDestination> destinations;
  ...
  /// a copy of the [IconThemeData.fallback] with a custom [HoverableNavigationRail]
  ...
  /// Overrides the default value of [HoverableNavigationRail]'s selection indicator color,
  ...
  /// Overrides the default value of [HoverableNavigationRail]'s selection indicator shape,
  /// when [useIndicator] is true.
  ///
  ...
  /// Returns the animation that controls the [HoverableNavigationRail.extended] state.
  ///
  ...
  /// [HoverableNavigationRail].
  ///
  /// An instance of `MyNavigationRailFab` is created for [HoverableNavigationRail.leading].
  /// Pressing the FAB button toggles the "extended" state of the [HoverableNavigationRail].
  ///
                      ...
                      children: <Widget>[
                        for (int i = 0; i < widget.destinations.length; i += 1)
                          _RailDestination(
                            ...
                            onHoverStateChange:
                                widget.destinations[i].onHoverStateChange,
                          ),
  ...
  Widget build(BuildContext context) {
    ...
    content = MouseRegion(
      onEnter: (pointerEnterEvent) {
        isHovered = true;
        if (widget.onHoverStateChange != null) {
          widget.onHoverStateChange!(isHovered);
        }
      },
    ...
    final bool primaryColorAlphaModified = colors.primary.a < 255.0;
